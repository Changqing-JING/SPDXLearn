...
if __name__ == "__main__":
    ...
    testfile1.set_checksum(Checksum(
        ChecksumAlgorithm.SHA1, "c537c5d99eca5333f23491d47ededd083fefb7ad"))
    ...
    testfile2.set_checksum(Checksum(
        ChecksumAlgorithm.SHA1, "bb154f28d1cf0646ae21bb0bec6c669a2b90e113"))
    ...
    license_set = LicenseConjunction(
        License.from_identifier(
            "Apache-2.0"), License.from_identifier("BSD-2-Clause")
    )
    ...
    relationship = Relationship(
        "TestPackage#SPDXRef-PACKAGE CONTAINS TestFilet#SPDXRef-FILE")
    doc.add_relationship(relationship)
    relationship = Relationship(
        "TestPackage#SPDXRef-PACKAGE CONTAINS TestFile2#SPDXRef-FILE")
    doc.add_relationship(relationship)
